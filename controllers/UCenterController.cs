    ...
    public partial class UCenterController : BaseWebController
    {
        ...
        public ActionResult EditUser()
        {
            ...
            if (errorList.Length == 1)
            {
                ...
                {
                    Credits.SendCompleteUserInfoCredits(WorkContext.StoreId, ref WorkContext.PartUserInfo, DateTime.Now);
                }
        ...
        public ActionResult UpdateMobile()
        {
            ...
            //发放验证手机积分
            Credits.SendVerifyMobileCredits(WorkContext.StoreId, ref WorkContext.PartUserInfo, DateTime.Now);
        ...
        public ActionResult UpdateEmail()
        {
            ...
            //发放验证邮箱积分
            Credits.SendVerifyEmailCredits(WorkContext.StoreId, ref WorkContext.PartUserInfo, DateTime.Now);
        ...
        public ActionResult ReviewProduct()
        {
            ...
            int payCredits = Credits.SendReviewProductCredits(WorkContext.StoreId, ref WorkContext.PartUserInfo, orderProductInfo, DateTime.Now);
