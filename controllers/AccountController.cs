...
namespace BrnMall.Web.Controllers
{
    ...
    public partial class AccountController : BaseWebController
    {
        ...
        public ActionResult Login()
        {
            ...
            returnUrl = Url.Action("index", "home",new RouteValueDictionary { { "area", "storeadmin" } });
            ...
            else//验证成功时
            {
                ...
                returnUrl = Url.Action("index", "home", new RouteValueDictionary { { "area", "malladmin" } });
        ...
        public ActionResult DybLogin()
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(redirectUrl))
                    return RedirectToAction("index", "home", new RouteValueDictionary {{"area", "storeadmin"}});
                else
        ...
        public ActionResult Register()
        {
            ...
            else//验证成功
            {
                ...
                userInfo.UserRid = UserRanks.GetLowestUserRank(userInfo.RegisterFromStoreId).UserRid;
                userInfo.StoreId = 0;
                ...
                //发放注册积分
                Credits.SendRegisterCredits(userInfo.RegisterFromStoreId, ref userInfo, DateTime.Now);
                //更新购物车中用户id
